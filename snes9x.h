...
struct SCPUState
{
	...
	bool8	SRAMModified;
	// neagix: notaz' additions, although offsets are not respected
	int32	APU_Cycles;
	// neagix: replaced by Timings.APUSpeedup = 1
//	bool8	APU_APUExecuting;	
};
...
struct SSettings
{
	...
	// neagix: TODO: remove this, this is an OpenGL port
	bool8	OpenGLEnable;
};
